                  ...
                  {RATIO_PRESETS.map((p) => {
                    ...
                    return (
                      <Button
                        ...
                        className={cn(
                          // Using h-auto to ensure the vertical stack doesn't compress
                          "h-auto flex flex-col items-center justify-center p-3 rounded-xl border transition-all duration-200 group",
                          isActive
                      ...
                      >
                        ...
                        <div
                          className={cn(
                            "text-[8px] uppercase font-medium transition-opacity",
                            isActive
                              ? "opacity-70"
