              ...
              {GLOBAL_PRESETS.map((p) => {
                ...
                return (
                  <Button
                    ...
                    className={cn(
                      "h-auto w-full flex flex-col items-center gap-2 p-2 rounded-xl border transition-all duration-200 group relative",
                      isActive
                        ? "bg-zinc-900 border-zinc-900 dark:bg-zinc-100 dark:border-zinc-100 shadow-md hover:bg-zinc-800 dark:hover:bg-zinc-200"
